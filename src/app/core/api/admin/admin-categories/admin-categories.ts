...
} from '../../admin/catalog/admin-catalog-api.service'
...
} from '../../admin/catalog/admin-catalog.models';
...
export class AdminCategories {
  ...
  readonly categoryDialogVisible =
    signal(false);

  readonly sizeDialogVisible =
    signal(false);
    ...
    computed(() =>
      this.categories().reduce(
        (
          ...
          total +
          category.prices_count,
        0,
      ),
    );

  readonly pizzasCount =
    computed(() =>
      this.categories().reduce(
        (
          total,
