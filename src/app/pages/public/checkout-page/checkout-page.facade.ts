...
import { CartItemDto } from '../../../core/api/cart/cart.models';
...
export type CheckoutStepId = 0 | 1 | 2;
...
export class CheckoutPageFacade {
  ...
  readonly loginRequestVersion =
    signal(0);

  requestLogin(): void {
    this.loginRequestVersion.update(
      value =>
        value + 1,
    );
  }
